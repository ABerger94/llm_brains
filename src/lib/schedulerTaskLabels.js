...
export const SCHEDULER_TASK_GROUPS = [
  {
    ...
    tasks: {
      ...
      autonomous_consolidation: 'Autonomous consolidation (graph digest)',
      pending_inbox_digest: 'Pending inbox digest (review queue)',
      ...
      exploration_run: 'Exploration run (self-initiated)',
      dual_dialogue: 'Dual dialogue (autonomous System Chat)',
    },
  },
  {
    label: 'Self & identity',
