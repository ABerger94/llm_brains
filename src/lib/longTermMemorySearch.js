 ...
 */
export async function searchLongTermMemory(query, limit = 5, longTermMemoryStore) {
  const LongTermMemory = longTermMemoryStore ?? getMindEntityStores().LongTermMemory;
